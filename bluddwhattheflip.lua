...
function library:new(props)
	-- // properties
	local textsize = props.textsize or props.TextSize or props.textSize or props.Textsize or 11
	...
	local color = props.color or props.Color or props.mainColor or props.maincolor or props.MainColor or props.Maincolor or props.Accent or props.accent or Color3.fromRGB(80, 220, 180)
	-- // variables
	local window = {}
	-- // main
...
function library:loader(props)
	...
	close[3].MouseButton1Down:Connect(function()
		close[2].BorderColor3 = Color3.fromRGB(120, 180, 255)
	...
	login[3].MouseButton1Down:Connect(function()
		login[2].BorderColor3 = Color3.fromRGB(120, 180, 255)
		outline:TweenPosition(UDim2.new(1.5,0,0.5,0),Enum.EasingDirection.Out,Enum.EasingStyle.Quad,0.75,true)
		logedin()
		wait(0.05)
...
function library:page(props)
	...
	button.MouseButton1Down:Connect(function()
		if page.open == false then
			for i,v in pairs(self.pages) do
				if v ~= page then
					if v.open then
						...
						v.open = false
						v.outline.BackgroundColor3 = Color3.fromRGB(60, 40, 100)
						v.line.Size = UDim2.new(1,0,0,2)
						v.line.BackgroundColor3 = Color3.fromRGB(60, 40, 100)
					end
				end
			end
			--
			...
			page.open = true
			page.outline.BackgroundColor3 = Color3.fromRGB(30, 40, 70)
			page.line.Size = UDim2.new(1,0,0,3)
			page.line.BackgroundColor3 = Color3.fromRGB(30, 40, 70)
		end
	end)
	--
...
function multisections:section(props)
	...
	button.MouseButton1Down:Connect(function()
		if mssection.open == false then
			for i,v in pairs(self.mssections) do
				if v ~= mssection then
					if v.open then
						v.page.Visible = false
						v.open = false
						v.outline.BackgroundColor3 = Color3.fromRGB(30, 30 ,30)
						v.line.Size = UDim2.new(1,0,0,2)
						v.line.BackgroundColor3 = Color3.fromRGB(30, 30 ,30)
					end
				end
			end
			--
			...
			mssection.open = true
			mssection.outline.BackgroundColor3 = Color3.fromRGB(60, 40, 100)
			mssection.line.Size = UDim2.new(1,0,0,3)
			mssection.line.BackgroundColor3 = Color3.fromRGB(60, 40, 100)
		end
	end)
	--
	local pointer = props.pointer or props.Pointer or props.pointername or props.Pointername or props.PointerName or props.pointerName or nil
...
function sections:toggle(props)
	...
	--
	local col = Color3.fromRGB(60, 40, 100)
	if def then
	...
	button.MouseButton1Down:Connect(function()
		if toggle.current then
			...
			toggle.color.BackgroundColor3 = Color3.fromRGB(60, 40, 100)
...
function sections:colorpicker(props)
	...
	utility.new(
		"UIGradient",
		{
			Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(80, 220, 180)), ColorSequenceKeypoint.new(0.10, Color3.fromRGB(120, 180, 255)), ColorSequenceKeypoint.new(0.20, Color3.fromRGB(200, 120, 255)), ColorSequenceKeypoint.new(0.30, Color3.fromRGB(255, 120, 220)), ColorSequenceKeypoint.new(0.40, Color3.fromRGB(120, 255, 220)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 255, 255)), ColorSequenceKeypoint.new(0.60, Color3.fromRGB(0, 102, 255)), ColorSequenceKeypoint.new(0.70, Color3.fromRGB(51, 0, 255)), ColorSequenceKeypoint.new(0.80, Color3.fromRGB(204, 0, 255)), ColorSequenceKeypoint.new(0.90, Color3.fromRGB(255, 0, 153)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(80, 220, 180))},
			Rotation = 90,
			Parent = outline4
		}
	)
